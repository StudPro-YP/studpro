    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-5xl mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-black mb-3">{session.title}</h1>
            ...
            {session.images.length > 1 && (
              <div className="grid grid-cols-3 gap-4 mt-4">
                {session.images.slice(1).map((image, idx) => (
                  <div key={idx} className="relative h-[120px] overflow-hidden rounded-lg">
                    <Image
                      src={image}
              ...
              <div className="space-y-4">
                ...
                {session.description && (
                  <div>
                    ...
                    <p className="text-secondary leading-relaxed">{session.description}</p>
                  </div>
                )}
              </div>
            </Card>
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-white">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-secondary">{session.speaker.title}</p>
                <p className="text-sm font-medium text-secondary">{session.speaker.company}</p>
              </div>
            </Card>
