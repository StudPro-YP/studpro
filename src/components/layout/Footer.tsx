...
export const FooterSocialLinks = () => (
  <div className="flex gap-4 items-center justify-center">
    <Link href="https://www.instagram.com/ieee.studpro/" target="_blank" rel="noopener noreferrer">
      <Instagram className="text-white hover:text-primary transition-colors" size={24} />
    </Link>
    <Link href="https://www.linkedin.com/company/ieee-studpro/" target="_blank" rel="noopener noreferrer">
        ...
        <div className="flex flex-row justify-around w-full px-16 py-8 mt-8">
            ...
            <div className="flex gap-12">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-white">Email: <Link className="hover:text-primary transition-colors" href="mailto:studpro@gmail.com">studpro@gmail.com</Link></p>
                </div>
            </div>
        </div>
