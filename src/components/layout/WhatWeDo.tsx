...
export const WhatWeDo = () => {
	...
	useLayoutEffect(() => {
		...
		rightContent.addEventListener("touchmove", preventScroll as EventListener, {
			passive: false,
		});
		...
		return () => {
			...
			rightContent.removeEventListener(
				"touchmove",
							...
							<div className="px-12 py-16 pt-32 space-y-16 h-full">
								<div className="space-y-8 ">
									...
									<p className="text-xl text-gray-600 leading-relaxed max-w-lg drop-shadow-xl">
										...
										and skills of all fresh graduates and undergraduates in Sri
										Lanka to the corporate world immediately after graduation or
										during the last stages of their degree. It was first started
										back in 2017 and has continued its journey for 7 successful
										years.
									</p>
								</div>
							</div>
