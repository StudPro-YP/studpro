...
const getUpcomingEvents = (eventData: StudProVersion[], limit = 3): UpcomingEvent[] => {
			...
			{upcomingEvents.length > 0 && (
				<div className="w-full max-w-7xl mb-16">
					<div className="mb-8 text-center ">
						<h2 className="text-4xl uppercase text-secondary font-bold mb-4">Upcoming Events</h2>
						<p className="text-lg mx-auto text-gray-600">Join us for our next exciting events where innovation meets inspiration. <br/> 
							Expand your horizons, connect with like-minded individuals, and take your skills to the next level.</p>
					</div>
