...
export function PartnerTimeline({ partnersByYear, selectedYear }: PartnerTimelineProps) {
  ...
  const sortedPartners = [...filteredPartners].sort((a, b) => a.year - b.year);
        ...
        {sortedPartners.map((yearGroup) => (
          <div key={yearGroup.year} className="mb-16 last:mb-0">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-2">Our valued partners for this year</p>
            </div>

            {/* Partner Cards Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {yearGroup.partners.map((partner, index) => (
