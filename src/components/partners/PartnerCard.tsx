                    ...
                    <div className="space-y-2 flex flex-col items-center">
                        ...
                        <div className="flex justify-center pt-2">
                            <div className={`flex gap-2 items-center ${
                                partner.partnerLevel === "Platinum" ? "text-purple-500" :
                                    partner.partnerLevel === "Gold" ? "text-amber-500" :
                                        partner.partnerLevel === "Silver" ? "text-gray-400" :
                                            partner.partnerLevel === "Bronze" ? "text-amber-700" :
                                                "text-blue-500"
                            }`}>
